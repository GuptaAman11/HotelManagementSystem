...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
		...
		lblName.setFont(new Font("plain", Font.PLAIN, 20));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            String allo_room = c1.getSelectedItem();
	    			...
	    			String check1 =  t5.getText();
                                String deposit =  t6.getText();
                                
                                
                                
                                String q1 = "insert into customer values('"+id+"','"+number+"','"+name+"','"+gender+"','"+country+"','"+allo_room+"','"+check1+"','"+deposit+"')";
                                String q2 = "update room set available = 'Occupied' where room = "+allo_room;
